...
import { InputDemo } from "./InputBox";
export default function Hero() {
  return (
    <div>
      <div className="flex bottom-0 sticky justify-center items-center mt-28 ">
        <h1 className="flex flex-row text-3xl font-semibold ">
          ...
          <span className="bg-gradient-to-r from-blue-600 via-green-400 to-pink-400 inline-block text-transparent bg-clip-text text-5xl">
            Ideas dump
          </span>
        </h1>
      </div>
